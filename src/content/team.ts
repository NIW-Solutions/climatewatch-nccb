...
export const teamContent = {
  ...
  advisors: [
    ...
    {
      slug: "ahmad-mahmood",
      image: "/images/team/ahmad-mahmood.webp",
      name: "Dr. Ahmad Mahmood",
      role: "External Advisor — Soil Science and Agroecosystem Resilience",
      summary:
        "Environmental scientist at the National University of Sciences and Technology, with a doctorate from the University of Yamanashi, Japan, and a publication record on soil and agroecosystem resilience.",
      profile: [
        "Dr. Ahmad Mahmood is ClimateWatch's External Advisor on Soil Science and Agroecosystem Resilience.",
        "He is an environmental scientist at the National University of Sciences and Technology in Islamabad, and holds a doctorate from the University of Yamanashi in Japan. His research covers soil science, agroecosystem resilience and sustainable agriculture, with a substantial record of peer-reviewed publication.",
        "He advises ClimateWatch on the soil and agricultural dimensions of its research and project work: the technical accuracy of analysis touching soils, land degradation and agroecosystems, the design of field studies with an agronomic component, and climate-resilient agriculture in the mountain and arid systems where ClimateWatch works.",
      ],
      expertise: [
        "Soil science",
        ...
        "Land degradation",
        "Field research design in agricultural systems",
      ],
    },
